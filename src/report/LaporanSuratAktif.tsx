...
const ReportArsiSuratAktif = () => {
  ...
  return (
    <Layout>
      <BreadCrumb title="Report Surat Keterangan Aktif" pageTitle="Report Surat Keterangan Aktif" />
      <div className="card">
      ...
      <div style={{ display: "none" }}>
        <ReportPrint ref={printRef} title="Report Surat Keterangan Aktif">
          <TableContainer
            isPagination={false}
            isTfoot={false}
            isSelect={false}
...
export default ReportArsiSuratAktif;
