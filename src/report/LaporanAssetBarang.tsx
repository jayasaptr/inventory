...
const LaporanAssetBarang = () => {
  ...
  return (
    <Layout>
      <BreadCrumb
        title="Report Asset / Barang"
        pageTitle="Report Asset / Barang"
      />
      <div className="card">
        <div className="card-body">
          <div className="flex gap-2 mb-4 justify-end">
            ...
            >
              ...
              {Array.from(new Set(data.map((item: any) => item.category))).map(
                (category: any) => (
      ...
      <div style={{ display: "none" }}>
        <ReportPrint ref={printRef} title="Report Asset / Barang">
          <TableContainer
            isPagination={false}
            isTfoot={false}
            isSelect={false}
...
export default LaporanAssetBarang;
