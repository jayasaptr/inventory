...
const ReportArsiSurat = () => {
  ...
  return (
    <Layout>
      <BreadCrumb title="Report Arsip Surat" pageTitle="Report Arsip Surat" />
      <div className="card">
        <div className="card-body">
          <div className="flex gap-2 mb-4 justify-end">
            ...
            >
              <option value="0">Semua Jenis Surat</option>
...
export default ReportArsiSurat;
